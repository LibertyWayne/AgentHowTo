...
| Page | Description |
|------|-------------|
| [framework-evolution.md](methodology/framework-evolution.md) | Analytical framework v1→v4.1, error-driven iteration |
| [knowledge-taxonomy.md](methodology/knowledge-taxonomy.md) | How the agent decides what to remember, store, archive, forget |
...
| Page | Description |
|------|-------------|
| [page-template.md](templates/page-template.md) | Template for new knowledge pages |
| [adr-template.md](templates/adr-template.md) | Template for Architecture Decision Records |
